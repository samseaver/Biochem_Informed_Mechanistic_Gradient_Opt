...
that. Regenerate them with `analyze_both_species.py` from a tree holding both
species, or point `BIOFLUX_DATA_DIR` at an existing copy. The phenotype data is
measured, not generated by this repository.
